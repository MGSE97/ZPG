...
Application::Engines::TriangleEngine* Application::Engines::TriangleEngine::Init(std::FILE* errorStream)
{
...
void Application::Engines::TriangleEngine::Update(::Engine::Components::Window* window)
{
